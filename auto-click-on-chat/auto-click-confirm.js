// Auto-click "Confirm" button in Chat
// This script runs periodically to check for and click the Confirm button
...
(function() {
    ...
    console.log('===============> Auto-click Confirm button script started...');
    
    // Start trying to add the icon
    waitAndAddIcon();
    
    // Function to find and click the Confirm button
    function findAndClickConfirmButton() {
        ...
        for (const iframe of iframes) {
            try {
                ...
                if (confirmButton) {
                    console.log('Found Confirm button in iframe, clicking...');
                    confirmButton.click();
                    return true;
                }
            } catch (e) {
    ...
    const intervalId = setInterval(() => {
        const clicked = findAndClickConfirmButton();
    ...
    window.acceptButtonAutoClicker = {
        ...
        stop: function() {
            ...
            console.log('Auto-click Accept button script stopped.');
        }
    };
